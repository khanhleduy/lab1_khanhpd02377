...
public class BookAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.img = convertView.findViewById(R.id.ivIconBook);
            ...
            holder.imgDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    sachDAO.deleteSachByID(arrSach.get(position).getmSach());
        ...
        holder.txtBookName.setText("Mã sách: " + _entry.getmSach());
        holder.txtSoLuong.setText("Số lượng: " + _entry.getSoLuong());
        holder.txtBookPrice.setText("Giá: " + _entry.getGiaBan() + "");
        return convertView;
    }
    ...
    private class CustomFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (Sach p : arrSach) {
                    if
                            (p.getmSach().toUpperCase().startsWith(constraint.toString().toUpperCase()))
                        lsSach.add(p);
                }
