...
public class CartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.txtSoLuong = (TextView) convertView.findViewById(R.id.tvSoLuong2);
        ...
        holder.txtMaSach.setText("Mã sách: " + _entry.getSach().getmSach());
        holder.txtSoLuong.setText("Số lượng: " + _entry.getSoLuongMua());
        holder.txtGiaBia.setText("Giá bìa: " + _entry.getSach().getGiaBan() + " vnd");
